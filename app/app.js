...
'      <jsr352:batchlet id="Batchlet_1e0j5a9" ref="org.jobstreamer.batch.ShellBatchlet" />' +
'    </jsr352:step>' +
...
'      <bpmn:outgoing>Transition_0db27b3</bpmn:outgoing>' +
...
'    <jsr352:step id="Step_14411x8">' +
'      <bpmn:incoming>Transition_0db27b3</bpmn:incoming>' +
'      <jsr352:batchlet id="Batchlet_130zl11" ref="org.jobstreamer.batch.ShellBatchlet" />' +
'    </jsr352:step>' +
'    <jsr352:step id="Step_0v13cp8">' +
'      <jsr352:chunk id="Chunk_1b8c3uj" name="aaa" />' +
'    </jsr352:step>' +
'    <jsr352:transition id="Transition_0db27b3" sourceRef="Step_1ws93bk" targetRef="Step_14411x8" />' +
'  </jsr352:job>' +
...
'      </bpmndi:BPMNShape>' +
'      <bpmndi:BPMNShape id="Step_14411x8_di" bpmnElement="Step_14411x8">' +
'        <dc:Bounds x="260" y="542" width="246" height="100" />' +
'      </bpmndi:BPMNShape>' +
'      <bpmndi:BPMNShape id="Batchlet_130zl11_di" bpmnElement="Batchlet_130zl11">' +
'        <dc:Bounds x="306" y="553" width="100" height="80" />' +
'      </bpmndi:BPMNShape>' +
'      <bpmndi:BPMNShape id="Step_0v13cp8_di" bpmnElement="Step_0v13cp8">' +
'        <dc:Bounds x="640" y="100" width="222" height="100" />' +
'      </bpmndi:BPMNShape>' +
'      <bpmndi:BPMNShape id="Chunk_1b8c3uj_di" bpmnElement="Chunk_1b8c3uj">' +
'        <dc:Bounds x="662" y="118" width="100" height="80" />' +
'      </bpmndi:BPMNShape>' +
'      <bpmndi:BPMNEdge id="Transition_0db27b3_di" bpmnElement="Transition_0db27b3">' +
'        <di:waypoint xsi:type="dc:Point" x="601" y="420" />' +
'        <di:waypoint xsi:type="dc:Point" x="601" y="481" />' +
'        <di:waypoint xsi:type="dc:Point" x="417" y="481" />' +
'        <di:waypoint xsi:type="dc:Point" x="417" y="542" />' +
'        <bpmndi:BPMNLabel>' +
'          <dc:Bounds x="509" y="456" width="0" height="0" />' +
'        </bpmndi:BPMNLabel>' +
'      </bpmndi:BPMNEdge>' +
'    </bpmndi:BPMNPlane>' +
'  </bpmndi:BPMNDiagram>' +
